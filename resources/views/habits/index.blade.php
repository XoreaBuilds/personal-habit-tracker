...
<div class="glass rounded-3xl p-12 text-center max-w-2xl mx-auto">
    ...
    <a href="{{ route('habits.create') }}" class="inline-flex items-center gap-2 px-8 py-3 rounded-full bg-primary hover:bg-primary/90 text-white font-bold transition-all hover:shadow-lg hover:shadow-primary/25">
        Get Started
    </a>
</div>
@else
    ...
    <div class="glass rounded-3xl p-6 glass-hover transition-all duration-300">
        <div class="flex justify-between items-start mb-6">
            ...
            <div class="flex gap-2">
                <a href="{{ route('habits.edit', $habit) }}" class="p-2 rounded-lg hover:bg-white/5 text-gray-400 transition-colors">
                            ...
                            <button type="submit" 
                                ...
                                @if($isCompleted)
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                                    </svg>
                                @endif
                            </button>
                        </form>
