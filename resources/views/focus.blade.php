        ...
        <div class="space-y-6">
            <div class="glass rounded-3xl p-6">
                ...
                <ul class="space-y-4 text-sm text-gray-400">
                    <li class="flex gap-3">
                        <span class="w-6 h-6 rounded-full bg-primary/10 text-primary flex items-center justify-center font-bold text-xs shrink-0">1</span>
                        Select a habit you want to work on.
                    </li>
                    <li class="flex gap-3">
                        <span class="w-6 h-6 rounded-full bg-primary/10 text-primary flex items-center justify-center font-bold text-xs shrink-0">2</span>
                        Focus for 25 minutes until the timer ends.
                    </li>
                    <li class="flex gap-3">
                        <span class="w-6 h-6 rounded-full bg-primary/10 text-primary flex items-center justify-center font-bold text-xs shrink-0">3</span>
                        Take a short break to recharge.
                    </li>
                    <li class="flex gap-3">
                        <span class="w-6 h-6 rounded-full bg-primary/10 text-primary flex items-center justify-center font-bold text-xs shrink-0">4</span>
